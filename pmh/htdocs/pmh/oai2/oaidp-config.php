   ...
   if (!$result1) {
      ...
      if ($num > 0) {
         for ($i1=0; $i1 < $num;$i1++) {
            ...
            # oai-datestamp: full (second) resolution
            $allresults[$dsid]['OAI_datestamp'] = $rowarr[3];
            # DS_datestamp and DS_creationDate: only day-resolution
