...
DIF, ISO19139 or MM2. They will be converted on export from the L<Metadata Store>.
...
EGIL, PLEASE CHECK THIS. ARE SEVERAL APPLICATION_IDs REALLY NEEDED? WHAT IS THE DIFFERENCE
BETWEEN APPLICATION_ID AND OWNERTAG?

The XMD and META files are stored in directories named APPLICATION_ID. There may be several
APPLICATION_IDs per instance in the case of ???
