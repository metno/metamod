...
see L<Installation|../installation> for details.

You must also set your C<PERL5LIB> to point to F<metamod/trunk/local/lib> in your environment,
or change C<CATALYST_LIB> in F<master_config.txt> (defaults to the Debian install directory):
