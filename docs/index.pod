...
=item L<Building the software|building>

How to build METAMOD from source (only for developers).
For installation of previously built versions, skip to the next chapter.

=item L<Installation|installation>

How to install the METAMOD base software package
...
=item L<API documentation|api/index>

Documentation for METAMOD Perl modules and scripts
