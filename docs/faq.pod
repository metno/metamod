...
=item Q: GoogleBot seems to bring down my site!

A: Add the following text to your robots.txt in the DocumentRoot directory
(changing "metamod" if you have set LOCAL_URL to something else):

  User-agent: *
  Disallow: /metamod/search/page
  Disallow: /metamod/subscription
  Disallow: /metamod/search/add_to_basket
  Disallow: /metamod/search/collectionbasket
  Disallow: /metamod/search/fimexdownload
