...
sub _list_identifiers {
    ...
    my $identifiers = $dataprovider->get_identifiers($params->{metadataPrefix}, $params->{from}, $params->{until},
                                                     $params->{set}, $params->{resumptionToken});
...
sub _list_records {
    ...
    my $records = $dataprovider->get_records($params->{metadataPrefix}, $params->{from}, $params->{until},
                                             $params->{set},$params->{resumptionToken});
