...
sub file_info {
    ...
    my @vars = [qw( data_file_location data_file_size distribution_statement dataref_HTTPServer )];
    my $metadata = $dataset->metadata( @vars );
    ...
    my $file_info = {
        ...
        HTTPServer         => $dataset->dataref_url('HTTPServer'), # $metadata->{dataref_HTTPServer}->[0],
