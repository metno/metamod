package Metamod::PrintUsererrors;
...
Metamod::PrintUsererrors - Port of the script print_errors.pl to module.
...
=head2 print_errors($config_file, $usererror_file $error_info_file)
...
sub print_errors {
    ...
    my $usererror_file = shift;
    my $errorinfo_file = shift;
    ...
    #
    open( HTMLOUT, ">$output_html_file" ) or die "Failed to open $output_html_file: $!";
